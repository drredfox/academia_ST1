...
class ASORSR_RscStructuredText{colorText[]={1,1,1,1};
	class Attributes{
		font="PuristaMedium";
		color="#ffffff";
		align="left";
...
class ASORSR_RscPicture{colorBackground[]={0,0,0,0};
	colorText[]={1,1,1,1};
	tooltipColorText[]={1,1,1,1};
	tooltipColorBox[]={1,1,1,1};
	tooltipColorShade[]={0,0,0,0.65};
...
class ASORSR_RscCombo{
	colorSelect[]={0,0,0,1};
	colorText[]={1,1,1,1};
	colorBackground[]={0,0,0,1};
	coloASORSR_Rscrollbar[]={1,0,0,1};
...
class ASORSR_RscListBox{colorText[]={1,1,1,1};
	colorDisabled[]={1,1,1,0.25};
...
class ASORSR_RscButton{colorText[]={1,1,1,1};
	colorDisabled[]={1,1,1,0.25};
...
class ASORSR_RscShortcutButton{
	class HitZone{
		left=0;
		top=0;
		right=0;
...
class  ASORSR_RscShortcutButtonMain{
	color[]={1,1,1,1};
	colorDisabled[]={1,1,1,0.25};
	class  HitZone{
		left=0;
...
class ASORSR_RscButtonMenu : ASORSR_RscShortcutButton{
	idc=-1;
	type=16;
	style="0x02 + 0xC0";
	default=0;
...
class ASORSR_RscButtonMenuOK{idc=1;
	shortcuts[]={"0x00050000 + 0",28,57,156};
	default=1;
	text="OK";
	soundPush[]={"\A3\ui_f\data\sound\RscButtonMenuOK\soundPush",0.09,1};
};
class ASORSR_RscButtonMenuCancel{idc=2;
	shortcuts[]={"0x00050000 + 1"};
	text="Cancel";
};
class ASORSR_RscControlsGroup{
...
class ASORSR_RscTitle : ASORSR_RscText {
	style = 0;
	sizeEx = "(			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
	colorText[] = {0.95, 0.95, 0.95, 1};
};
