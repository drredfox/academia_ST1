...
if(Curveh in UGV)then{
	player linkItem (["B_UavTerminal", "O_UavTerminal", "I_UavTerminal"] select ([WEST, EAST, RESISTANCE] find (side player)));
	createVehicleCrew _spawn_veh;
};
if(Curveh in UAV)then{
	player linkItem (["B_UavTerminal", "O_UavTerminal", "I_UavTerminal"] select ([WEST, EAST, RESISTANCE] find (side player)));
	createVehicleCrew _spawn_veh;
};
if(Curveh in UAV_Portatil)then{
	player linkItem (["B_UavTerminal", "O_UavTerminal", "I_UavTerminal"] select ([WEST, EAST, RESISTANCE] find (side player)));
	createVehicleCrew _spawn_veh;
};
};