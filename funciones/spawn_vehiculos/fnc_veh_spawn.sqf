...
if(_spawn_veh isKindof "Helicopter")then{_spawn_veh addAction [("<t color=""#D13DCF"">" + "Activar modo instructor" + "</t>"), "scripts\vinstruct.sqf", [], 3, false, true, "", "player in _target"];};
